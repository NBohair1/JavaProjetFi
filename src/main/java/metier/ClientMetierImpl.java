...
public class ClientMetierImpl implements IClientMetier {
    ...
    public Client creerClient(
        ...
        try {
            ...
            if (nom == null || nom.trim().isEmpty())
                throw new ClientException("Veuillez entrer le nom");
            
            if (prenom == null || prenom.trim().isEmpty())
                throw new ClientException("Veuillez entrer le prenom");

            if (telephone == null || telephone.trim().isEmpty())
                throw new ClientException("Veuillez entrer le telephone");

            // Vérifier format téléphone basique
            String telNormalise = telephone.trim().replaceAll("[\\s-]", "");
            if (telNormalise.length() < 8) {
                throw new ClientException("Numero de telephone trop court");
            }

            // Vérifier si le téléphone existe déjà
            Client existant = dao.findOneByProperty(Client.class, "telephone", telephone);
            if (existant != null)
                throw new ClientException("Ce numero est deja utilise");
    ...
    public Client modifierClient(
        ...
        try {
            ...
            if (client == null)
                throw new ClientException("Client non selectionne");
    ...
    public void supprimerClient(Client client) throws ClientException {
        ...
        try {
            ...
            if (clientManaged == null) {
                throw new ClientException("Client introuvable");
            }
            ...
            if (!reparations.isEmpty()) {
                ...
                if (hasActiveRepairs) {
                    throw new ClientException("Ce client a des reparations en cours");
                }
                
                // Message informatif si le client a des réparations terminées
                throw new ClientException("Ce client a un historique de reparations");
            }
    ...
    public Client rechercherClientParId(Long id) throws ClientException {
        if (id == null)
            throw new ClientException("Veuillez selectionner un client");
    ...
    public Client rechercherClientParTelephone(String telephone) throws ClientException {
        if (telephone == null || telephone.isEmpty())
            throw new ClientException("Veuillez entrer un telephone");
    ...
    public List<Client> listerClientsParBoutique(Boutique boutique) throws ClientException {
        if (boutique == null) {
            throw new ClientException("Boutique non selectionnee");
        }
    ...
    public Reparation suivreReparationParCode(String codeSuivi) throws ClientException {
        if (codeSuivi == null || codeSuivi.isEmpty())
            throw new ClientException("Veuillez entrer le code de suivi");
        
        Reparation reparation = dao.findOneByProperty(Reparation.class, "codeSuivi", codeSuivi);
        
        if (reparation == null)
            throw new ClientException("Code de suivi introuvable");
