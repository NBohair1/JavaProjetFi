            ...
            if (stats != null) {
                ...
                if (parentFrame instanceof MainFrame) {
                    donnees = new Object[][]{
                        ...
                        {"Caisse reelle", String.format("%.2f DH", stats.getCaisseReelle())},
                        ...
                        {"Revenus periode (30j)", String.format("%.2f DH", stats.getRevenusPeriode())},
                        {"Reparations terminees", String.valueOf(stats.getNombreReparationsTerminees())},
                        {"Total reparations", String.valueOf(stats.getNombreReparations())}
                    };
                } else {
                    donnees = new Object[][]{
                        {"Caisse", String.format("%.2f DH", stats.getCaisse())},
